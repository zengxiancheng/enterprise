...
<form action="<%=path%>/manage/device" id="form" method="post">
            ...
            <tr>
             ...
             <tr>
                ...
                <c:choose>
                        ...
                        <c:otherwise>
                        <select id="unit" name="unit" >
                            <option value="m³/s" <c:if test="${'m³/s' eq e.unit}">selected="selected" </c:if>>m³/s</option>
                            <option value="m/s" <c:if test="${'m/s' eq e.unit}">selected="selected" </c:if>>m/s</option>
                            <option value="kPa" <c:if test="${'kPa' eq e.unit}">selected="selected" </c:if>>kPa</option>
                            <option value="℃" <c:if test="${'℃' eq e.unit}">selected="selected" </c:if>>℃</option>
                            <option value="m" <c:if test="${'m' eq e.unit}">selected="selected" </c:if>>m</option>                       
                       </select>
                        </c:otherwise>
                    </c:choose>
              ...
              <tr>
                ...
                <td style="text-align: left;">                     
                        <c:choose>
                        <c:when test="${empty e.communicateMode}">
                        ...
                        <c:otherwise>
                        <select id="communicateMode" name="communicateMode" >
                            <option value="HTTP" <c:if test="${'HTTP' eq e.communicateMode}">selected="selected" </c:if>>HTTP</option>
                            <option value="MQTT" <c:if test="${'MQTT' eq e.communicateMode}">selected="selected" </c:if>>MQTT</option>
                            <option value="COAP" <c:if test="${'COAP' eq e.communicateMode}">selected="selected" </c:if>>COAP</option>                      
                       </select>
                        </c:otherwise>
                    </c:choose>                                           
                </td>
